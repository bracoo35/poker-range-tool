...
deal_button = Button(root, text='Show flop', command=showFlop)
deal_button.grid(row=6, column= 15 )
deal_button = Button(root, text='Show turn', command=showTurn)
deal_button.grid(row=6, column= 16 )
deal_button = Button(root, text='Show river', command=showRiver)
deal_button.grid(row=6, column= 17 )

show_button = Button(root, text='New community cards', command=updateCommCards)
show_button.grid(row=14, column= 15, columnspan=2 )
