...
my_label.grid(row=14, column=15 )

my_label2 = Label(image=my_img2)
my_label2.grid(row=14, column=16 )

my_label3 = Label(image=my_img3)
my_label3.grid(row=14, column=17 )

my_label4 = Label(image=my_img4)
my_label4.grid(row=14, column=18 )

my_label5 = Label(image=my_img5)
my_label5.grid(row=14, column=19 )
